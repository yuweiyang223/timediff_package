#' timediff() function
#'
#' This function calculate the time difference between two dates.It will return the time difference as a number in years rounded to two decimal places
#'
...
#'
#' @return A number in unit of year rounded to two decimal places
#'
#' @details Inputs need to be in date format. You may use as.Date() or ymd() from lubridate package to change the character or number into date. If your inputs are not date, the function will return an error message and tells you what format you have entered. So you can make adjustments accordingly.
#'
#' @examples
